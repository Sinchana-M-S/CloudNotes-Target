...
const fileUpload = require('express-fileupload').default; // require the default export to prevent path traversal. const app = express(); app.use(fileUpload({ uploadDir: path.join(__dirname, 'uploads') })); // specify the upload directory to prevent path traversal.
