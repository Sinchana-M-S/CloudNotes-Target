...
const axios = require('axios').default; // Ensure axios is used with the default instance to prevent SSRF attacks. Alternatively, use a custom instance with a proxy or a specific URL to prevent SSRF attacks.
