...
const axios = require('axios').default; // Ensure axios is used with its default instance to prevent SSRF attacks. Alternatively, use a secure URL parsing library like url-join to construct URLs safely.
